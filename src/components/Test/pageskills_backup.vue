<template>
  <PageLayoutMiddle :active="active">
    ...
    <div class="grid grid-rows-1 grid-cols-3 gap-4 w-full">
      <div class="flex-1 flex flex-col justify-center">
        <WrapperText :active="active" title="Skills">
          <ContentDecorator>
      ...
      <!-- <div
        class="flex-1 flex flex-col justify-center animate__animated" 
      ...
      <div class="col-span-2 skills-main grid grid-rows-3 grid-cols-3">
